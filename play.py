...
GROQ_API_KEY = os.getenv("GROQ_API_KEY", "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")
...
SYSTEM_PROMPT = (
    ...
    "   Inspired by: [specific data point - e.g., 'Mariah Carey trending in posts', '{sentiment_pct.get('negative', 0):.0f}% posts showing queue stress', 'Christmas tree emoji appearing in {mentions_total} posts']\n\n"
    ...
    "   Inspired by: Shopping queue stress appearing in {sentiment_pct.get('negative', 0):.0f}% of posts\n\n"
    ...
    "   Inspired by: Baking themes and {sentiment_pct.get('negative', 0):.0f}% posts showing festive pressure\n\n"
